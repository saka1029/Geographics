...
public class GoogleMaps {
	...
	/**
	 * 経度からGoogleMapsの経度ピクセル座標値を求めます。
	 * @param x 経度を指定します。
	 * @param z ズームレベルを指定します。
	 * @return GoogleMapsの経度ピクセル座標値を返します。
	 */
	...
	/**
	 * 緯度からGoogleMapsの緯度ピクセル座標値を求めます。
	 * @param x 緯度を指定します。
	 * @param z ズームレベルを指定します。
	 * @return GoogleMapsの緯度ピクセル座標値を返します。
	 */
	...
	/**
	 * GoogleMapsの経度ピクセル座標値から経度を求めます。
	 * @param p GoogleMapsの経度ピクセル座標値を指定します。
	 * @param z ズームレベルを指定します。
	 * @return 経度を返します。
	 */
	...
	/**
	 * GoogleMapsの緯度ピクセル座標値から緯度を求めます。
	 * @param p GoogleMapsの緯度ピクセル座標値を指定します。
	 * @param z ズームレベルを指定します。
	 * @return 緯度を返します。
	 */
